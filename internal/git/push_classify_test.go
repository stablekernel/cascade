...
func TestRetryablePushRejection(t *testing.T) {
	retryable := map[string]string{
		...
		"rate limit 429":      "fatal: unable to access 'https://github.com/o/r.git/': The requested URL returned error: 429",
		"secondary rate":      "remote: You have exceeded a secondary rate limit. Please wait a few minutes before you try again.\nfatal: unable to access 'https://github.com/o/r.git/': The requested URL returned error: 403",
		"retry-after":         "remote: Too many requests. Retry-After: 60\nfatal: unable to access 'https://github.com/o/r.git/': The requested URL returned error: 429",
		"rpc transport blip":  "error: RPC failed; curl 56 Recv failure: Connection reset by peer",
	...
	permanent := map[string]string{
		...
		"rpc http 400":         "error: RPC failed; HTTP 400 curl 22 The requested URL returned error: 400",
		"rpc http 401":         "error: RPC failed; HTTP 401 curl 22 The requested URL returned error: 401",
		"rpc http 403":         "error: RPC failed; HTTP 403 curl 22 The requested URL returned error: 403",
